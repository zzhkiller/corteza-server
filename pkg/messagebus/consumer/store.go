...
func NewStoreConsumer(q string, s store.QueueStorer) *StoreConsumer {
	h := &StoreConsumer{
		queue:  q,
...
func (cq *StoreConsumer) SetStore(s store.QueueStorer) {
	cq.client.SetStore(s)
}

func (cq *StoreConsumer) GetStore() store.QueueStorer {
